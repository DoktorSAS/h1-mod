...
namespace demonware
{
	bdMarketplace::bdMarketplace() : service(80, "bdMarketplace")
	{
		...
		this->register_task(122, &bdMarketplace::purchase_skus); // apparently its called skus
	...
	{
#ifdef DEBUG
		utils::io::write_file("demonware/bdMarketplace/purchase_skus", buffer->get_buffer());
#endif
